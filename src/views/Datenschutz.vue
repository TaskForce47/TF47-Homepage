<template>
  <div class="datenschutz container relative">
    <section class="sm:float-right sm:w-16"><Navigation></Navigation></section>
    <section class="pt-72 pb-40">
      <div class="header w-5/6 mx-auto mb-4">
        <h1 class="text-3xl text-white font-bold">
          UNSERE DATENSCHUTZERKL&Auml;RUNG
        </h1>
        <h2 class="bg-white text-xl w-fit font-light px-1">
          Datenschutz auf einen Blick
        </h2>
      </div>

      <div class="text-field bg-white w-5/6 px-3 py-5 mx-auto">
        ...
        <p>
          <strong
            >Abschluss eines Vertrages &uuml;ber Auftragsverarbeitung</strong
          >
        </p>
        <p>
        ...
        <p>
          Christian Grandjean<br />
          Creceliusstra&szlig;e 32<br />
          42327 Wuppertal, Deutschland
        </p>
        <p>E-Mail: Christian.Grandjean@web.de</p>
        <p>
        ...
        <p>
          ...
          Abs. 1 lit. a DSGVO gespeichert. Die Einwilligung ist jederzeit
          f&uuml;r die Zukunft widerrufbar.
        </p>
        <p>
    ...
    <section><FooterBar></FooterBar></section></div
></template>
...
@media (min-width: 768px) {
  .datenschutz {
    background: url("./../assets/background-datenschutz.jpg") no-repeat center
      top !important;
    max-width: 1920px;
    height: 3420px;
  }
